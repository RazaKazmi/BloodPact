...
public class Relic_MeleeDmg : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        relic = allRelicsObject.GetComponent<AllRelics>().MeleeDmg; // set our relic equal to the speific relic we want
        GameInformation.entities.player.GetComponent<Player>().meleeDamageIncrease += relic.increaseValue;
