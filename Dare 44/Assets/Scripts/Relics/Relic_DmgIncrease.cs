...
public class Relic_DmgIncrease : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        relic = allRelicsObject.GetComponent<AllRelics>().DmgIncrease; // set our relic equal to the speific relic we want
        GameInformation.entities.player.GetComponent<Player>().damageIncrease += relic.increaseValue;
